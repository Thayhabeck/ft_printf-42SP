...
/*   Updated: 2022/06/03 21:24:06 by thabeck-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static char	*ft_fillcpy(char *dest, const char *src, size_t size)
{
	size_t	i;
...
static char	*ft_makesplit(char const *s, char c, int n)
{
	int		start;
	int		end;
	int		count;
